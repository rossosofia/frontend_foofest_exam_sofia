...
export default function TentCardNoOption() {
  ...
  const { num2PersonTents, num3PersonTents } =
    CalculateTents(totalBasketTickets);
      ...
      <div className="bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl mb-4 mt-4">
        <div className="md:flex">
          <div className="p-8">
            ...
            <p className="mt-2 text-gray-500">299-</p>
            <div className="w-32">{num2PersonTents}</div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl mb-4">
        <div className="md:flex">
          <div className="p-8">
            ...
            <p className="mt-2 text-gray-500">399,-</p>
            <div className="w-32">{num3PersonTents}</div>
          </div>
        </div>
      </div>
    </div>
