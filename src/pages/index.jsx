...
export default function Home() {
  ...
  function calculateTents(numPeople) {
    ...
    console.log("There is no valid arrangement to accommodate all people without empty spaces.");
    console.log("You may need to adjust the number of people or consider an alternative solution.");
    return null;
  }
  
  // Example usage
  const totalPeople = 18;
