  ...
  return (
    <Layout>
      ...
      <section className="py-12">
        <div className="flex flex-wrap gap-2 justify-between items-center my-10 pb-5 px-10 ">
      ...
      <section className="mx-auto h-[85vh] flex flex-col md:flex-row items-center justify-center py-4 px-10 mb-10">
